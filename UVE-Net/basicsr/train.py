...
#    device_id = torch.cuda.current_device()
#    resume_state = torch.load("/data1/benchemark/DSTNet-main/experiments/Our_GOPRO/training_states/105000.state", map_location=lambda storage, loc: storage.cuda(device_id))
#    check_resume(opt, resume_state['iter'])    
    return resume_state
...
def train_pipeline(root_path):
    ...
    result = create_train_val_dataloader(opt, logger)#here opt pass Parameter
